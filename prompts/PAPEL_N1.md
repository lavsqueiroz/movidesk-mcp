...
O Agente N1 é responsável pelos tickets nos seguintes status:
...
2. Usuário escolhe um ticket para analisar
...
1. **Nunca crie notas sem aprovação explícita** do usuário
